...
// 元テキスト（長文でもOK）
let sourceTexts = [
  "ゲノム編集技術は、生命科学における飛躍的なブレイクスルーであり、生物の遺伝子を狙った通りに改変することを可能にした。この技術の応用は広範であり、特に難病の治療法開発や、品種改良による食糧生産の安定化に大きな期待が寄せられている。例えば、従来の治療法では困難だった遺伝性の疾患に対して、根本的な遺伝子の修正を行うジーン・セラピーの可能性が開かれている。しかし、ゲノム編集は、ヒトの生殖細胞（卵子や精子）に適用された場合、その改変が次世代以降に受け継がれるという重大な倫理的問題を提起する。したがって、意図しない副作用や、人類の遺伝的多様性を損なう可能性を考慮し、国際的な議論と厳格な規制が求められている。技術の進歩を最大限に活かしつつ、生命の尊厳と社会の公平性をどのように守っていくかが、科学者だけでなく社会全体の課題である。私たちは、技術の利便性と倫理的な境界線を常に意識しながら、この革新的なツールと慎重に向き合っていく必要がある。"
  ];
